 ...
 */
@WebServlet(name = "BackProdEditServlet",urlPatterns = {"/back/BackProdEditServlet"})
public class BackProdEditServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            response.setHeader("refresh","1;url="+request.getContextPath()+"/back/BackProdListServlet");
